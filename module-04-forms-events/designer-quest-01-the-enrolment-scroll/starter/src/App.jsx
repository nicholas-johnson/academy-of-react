...
export default function App() {
  ...
  const handleSubmit = (e) => {
    ...
    // 🎨 TASK 3 — The number 3 below is the minimum name length.
    ...
    // 🎨 TASK 2 — Change the message between the backticks.
    //              This is what the student sees after enrolling.
    //              You can use ${name}, ${house}, and ${level} inside the message.
        ...
        <div className="form-group">
          ...
          <select id="house" name="house" value={house} onChange={handleChange}>
            ...
            {/* 🎨 TASK 1 — Add a new house option below this line.
                           Copy one of the lines above and change the name. */}
          </select>
        </div>
