...
function TailwindButton({ variant = 'primary', children }) {
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:shadow-lg hover:shadow-indigo-500/40',
    secondary: 'bg-transparent text-indigo-400 border-2 border-indigo-400 hover:bg-indigo-400/10',
    danger: 'bg-gradient-to-r from-rose-500 to-rose-600 text-white hover:shadow-lg hover:shadow-rose-500/40'
  }
    ...
    <div>
      ...
      <div className="demo-grid">
        ...
        <div className="demo-section">
          ...
          <pre style={{ marginTop: '1rem', fontSize: '0.75rem', color: '#64748b', background: 'rgba(0,0,0,0.3)', padding: '0.5rem', borderRadius: '0.25rem', overflow: 'auto' }}>
{`import styles from './Button.module.css'
...
\``}
        ...
        <div className="demo-section">
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            <TailwindButton 
              variant="primary"
              onClick={() => setClicks(c => ({ ...c, tailwind: c.tailwind + 1 }))}
            >
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
          <thead>
            <tr style={{ borderBottom: '2px solid rgba(255,255,255,0.1)' }}>
              <th style={{ padding: '1rem', textAlign: 'left', color: '#a5b4fc' }}>Feature</th>
              <th style={{ padding: '1rem', textAlign: 'center', color: '#a5b4fc' }}>CSS Modules</th>
              <th style={{ padding: '1rem', textAlign: 'center', color: '#a5b4fc' }}>Styled Components</th>
              <th style={{ padding: '1rem', textAlign: 'center', color: '#a5b4fc' }}>Tailwind</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <td style={{ padding: '0.75rem', textAlign: 'center' }}>❌</td>
              <td style={{ padding: '0.75rem', textAlign: 'center' }}>✅</td>
              <td style={{ padding: '0.75rem', textAlign: 'center' }}>⚠️ (via classnames)</td>
            </tr>
            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
