...
**Note**: This is NOT how you'd normally do it! Module 4 introduces `useState` for proper state management.
...
**Module 4** introduces proper state management with `useState` - no more manual re-rendering!
