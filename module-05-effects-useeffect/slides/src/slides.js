...
function MyComponent() {
  ...
  },
  {
    ...
    content: {
      ...
      rules: [
        ...
        { rule: 'With deps [a, b]', example: 'Runs when a or b changes', icon: '👀' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      rules: [
        { rule: 'Timers', example: 'clearInterval() / clearTimeout()', icon: '⏱️' },
        { rule: 'Event Listeners', example: 'removeEventListener()', icon: '👂' },
        { rule: 'Subscriptions', example: 'unsubscribe() / disconnect()', icon: '🔔' },
        { rule: 'Fetch (optional)', example: 'AbortController.abort()', icon: '🛑' }
      ]
    }
  },
  {
