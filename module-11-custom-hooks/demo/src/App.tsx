    ...
    <div className="app">
      ...
      <div className="demo-section">
        ...
        <div className="button-group">
          ...
          <button onClick={counter.reset} className="btn btn-secondary">Reset</button>
      ...
      <div className="info-box">
        ...
        <ul>
          ...
          <li><strong>Composition</strong>: Build hooks from other hooks</li>
          <li><strong>Testability</strong>: Test logic independently</li>
          <li><strong>Separation</strong>: Separate concerns cleanly</li>
          <li><strong>Convention</strong>: Always start with "use"</li>
        </ul>
      </div>
    </div>
  )
