...
function App() {
  const [profile, setProfile] = useLocalStorage<WizardProfile>('wizardProfile', {
  ...
  return (
    <div className={`app ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="profile-card">
        ...
        <div className="form-group">
          <label>House</label>
          <select value={profile.house} onChange={(e) => handleHouseChange(e.target.value)}>
      ...
      <div className="info-box">
        ...
        <ul>
          <li>Generic type: <code>useLocalStorage&lt;T&gt;</code></li>
